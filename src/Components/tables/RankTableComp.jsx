      ...
      <Table sx={{
        ...
        <TableHead>
          <TableRow>
            ...
            <TableCell align="center" sx={{ backgroundColor: '#d11108', color: 'white', fontWeight: 'bold', padding: '4px', fontSize: '0.8rem' }}>Acciones</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
